...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Eo(e,t,n){let r=new Float32Array(fo),i=new W(0,1,0);return new qi({name:`SphericalGaussianBlur`,defines:{n:fo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ko(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Do(){return new qi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ko(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oo(){return new qi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ko(),fragmentShader:`
	...
	`}var Ao=class extends an{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ji(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=qs(i,i.VERTEX_SHADER,y),S=qs(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=$s(i,x,`vertex`),n=$s(i,S,`fragment`);V(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      </div>`,O.addEventListener(`click`,()=>ee(`10`)),!D)return;D.appendChild(O),Object.keys(Ll).map(e=>{let t=Ll[e],n=document.createElement(`button`);n.className=`planet-button`,n.innerHTML=`
        <div class="planet-row">
            <div class="planet-name-container">
                <span class="sun-dot" style = "background-color: ${t.color}"></span>
                <span class="planet-name">${t.name.toUpperCase()}</span>
            </div>
            <span class="planet-distance">${t.a.toFixed(2)} AU</span>
        </div>`,n.addEventListener(`click`,()=>ee(e)),D&&D.appendChild(n)});let k=[new W(0,0,0),new W(0,0,0)],A=new Ei(new Rr().setFromPoints(k),new yi({color:16724787,transparent:!0,opacity:.6}));n.add(A);function ee(e){o.current=e,T(),E();let t=document.getElementById(`cam-mode`);e===`10`?t.textContent=`ORBITAL FREE`:t.textContent=`TRACKING: ${Ll[e].name.toUpperCase()}`}let te=document.getElementById(`date-picker`);te.value=r.current.toISOString().split(`T`)[0],document.getElementById(`btn-rewind`).addEventListener(`click`,()=>{a.current>.1?a.current/=2:a.current>=-10&&--a.current,Ul(a)}),document.getElementById(`btn-play-pause`).addEventListener(`click`,()=>{i.current=!i.current,document.getElementById(`btn-play-pause`).textContent=i.current?`PAUSE`:`PLAY`}),document.getElementById(`btn-forward`).addEventListener(`click`,()=>{a.current<0?a.current+=1:a.current===0?a.current=1:a.current*=2,Ul(a)}),document.getElementById(`btn-today`).addEventListener(`click`,()=>{r.current=new Date,te.value=r.current.toISOString().split(`T`)[0]});let j=document.getElementById(`chk-orbits`);j.addEventListener(`change`,()=>{s.current=j.checked});let ne=document.getElementById(`chk-grid`);ne.addEventListener(`change`,()=>{c.current=ne.checked,v&&(v.visible=c.current)});let re=document.getElementById(`chk-labels`);re.addEventListener(`change`,()=>{u.current=re.checked});let M=document.getElementById(`chk-real-scale`);M.addEventListener(`change`,()=>{d.current=M.checked,y()});let N=new qa,ie,ae=()=>{ie=requestAnimationFrame(ae),x.rotation.y+=.005,C.forEach((e,t)=>{e.rotation.z+=(t%2==0?1:-1)*.002;let n=1+Math.sin(Date.now()*.001+t)*.03;e.scale.set(n,n,1)}),Object.keys(w).forEach(e=>{w[e].bodyMesh.rotation.y+=.01}),Object.keys(Ll).forEach(e=>{let n=Ll[e],i=w[e],a={x:0,y:0,z:0};a=Hl(e,r.current);let o=Math.sqrt(a.x*a.x+a.y*a.y+a.z*a.z),l=Bl(o,!1)/(o||1),f=a.x*l,m=a.z*l,h=a.y*l;if(i.group.position.set(f,m,h),s.current){i.orbitLine.visible=!0;let t=[];for(let n=0;n<=128;n++){let r=Vl(e,n/128*360),i=Math.sqrt(r.x*r.x+r.y*r.y+r.z*r.z),a=Bl(i,d.current)/(i||1);t.push(new W(r.x*a,r.z*a,r.y*a))}i.orbitLine.geometry.setFromPoints(t)}else i.orbitLine.visible=!1;if(c.current){i.leadLine.visible=!0;let e=[new W(f,m,h),new W(f,0,h)];i.leadLine.geometry.setFromPoints(e),i.leadLine.computeLineDistances()}else i.leadLine.visible=!1;if(u.current){i.label.style.opacity=`1`;let e=new W(f,m+n.radius+.3,h);if(e.project(p),e.z>1)i.label.style.opacity=`0`;else{if(!t.current)return;let n=(e.x*.5+.5)*t.current.clientWidth;if(i.label.style.left=`${n}px`,!t.current)return;let r=(e.y*-.5+.5)*t.current.clientHeight;i.label.style.top=`${r}px`}}else i.label.style.opacity=`0`});let e=N.getDelta();i.current&&(r.current.setTime(r.current.getTime()+a.current*e*864e5),te.value=r.current.toISOString().split(`T`)[0]);let o=new Date().toUTCString().split(` `)[4];document.getElementById(`hud-time`).textContent=o;let l=p.position.y/(p.position.length()||1)*(180/Math.PI);document.getElementById(`cam-lat`).textContent=`${l.toFixed(2)}°`,T(),g.update(),m.render(n,p)};return ae(),window.addEventListener(`resize`,h),()=>{cancelAnimationFrame(ie),window.removeEventListener(`resize`,h),m.dispose(),t.current?.contains(m.domElement)&&t.current?.removeChild(m.domElement)}},[]),(0,$.jsxs)(`div`,{className:`scene-panel`,id:`scene-panel`,children:[(0,$.jsx)(`div`,{ref:t,className:`three-container`}),(0,$.jsxs)(`div`,{className:`hud-top-right`,children:[(0,$.jsxs)(`div`,{className:`hud-box`,children:[`CAM_MODE: `,(0,$.jsx)(`span`,{id:`cam-mode`,children:`ORBITAL FREE`})]}),(0,$.jsxs)(`div`,{className:`hud-box`,children:[`ECLIPTIC_LAT: `,(0,$.jsx)(`span`,{id:`cam-lat`,children:`0.00°`})]})]}),(0,$.jsxs)(`div`,{className:`hud-bottom-left`,children:[(0,$.jsxs)(`div`,{className:`hud-box`,children:[`GRID_SCALE: `,(0,$.jsx)(`span`,{children:`1.0 AU / DIV`})]}),(0,$.jsxs)(`div`,{className:`hud-box`,children:[`SYSTEM_TIME: `,(0,$.jsx)(`span`,{id:`hud-time`,children:`--:--:--`})]})]}),(0,$.jsx)(`div`,{className:`compass`,children:(0,$.jsxs)(`div`,{className:`compass-circle`,children:[(0,$.jsx)(`div`,{className:`compass-center`}),(0,$.jsx)(`div`,{className:`compass-horizontal`}),(0,$.jsx)(`div`,{className:`compass-vertical`})]})})]})}function Gl(){return(0,$.jsxs)(`div`,{className:`hud-panel`,children:[(0,$.jsx)(`div`,{className:`hud-top-line`}),(0,$.jsxs)(`div`,{style:{padding:`3cqw 3cqw`},children:[(0,$.jsxs)(`div`,{className:`hud-row`,children:[(0,$.jsx)(`div`,{children:`SYSTEM: ACTIVE`}),(0,$.jsxs)(`div`,{className:`hud-live`,children:[(0,$.jsx)(`div`,{className:`dot`}),`LIVE SYNC`]})]}),(0,$.jsx)(`div`,{className:`hud-title`,children:`HORIZONS 3D`}),(0,$.jsx)(`div`,{className:`hud-subtitle`,children:`NASA JPL EPHEMERIS TELEMETRY HUD`}),(0,$.jsx)(`div`,{className:`scanlines`})]})]})}function Kl(){return(0,$.jsxs)(`div`,{className:`settings-panel`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`div`,{className:`settings-title-box`,children:[(0,$.jsx)(`span`,{children:`SIMULATION DATE`}),(0,$.jsx)(`span`,{id:`date-source-badge`,className:`date-source-badge`,children:`NASA API`})]}),(0,$.jsx)(`input`,{type:`date`,id:`date-picker`,className:`date-picker`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{className:`settings-label`,children:`TIME WARP`}),(0,$.jsxs)(`div`,{className:`time-warp-buttons`,children:[(0,$.jsx)(`button`,{id:`btn-rewind`,className:`warp-button`,children:`◀◀`}),(0,$.jsx)(`button`,{id:`btn-play-pause`,className:`warp-button`,children:`PAUSE`}),(0,$.jsx)(`button`,{id:`btn-forward`,className:`warp-button`,children:`▶▶`}),(0,$.jsx)(`button`,{id:`btn-today`,className:`warp-button`,children:`TODAY`})]}),(0,$.jsxs)(`div`,{className:`warp-speed`,children:[(0,$.jsx)(`span`,{children:`SPEED:`}),(0,$.jsx)(`span`,{id:`warp-speed-text`,className:`warp-speed-value`,children:`1.0x / DAY`})]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{className:`settings-label`,children:`VISUAL SCHEMATICS`}),(0,$.jsxs)(`div`,{className:`schematics-list`,children:[(0,$.jsxs)(`label`,{className:`schematic-option`,children:[(0,$.jsx)(`span`,{children:`ORBITAL TRACKS`}),(0,$.jsx)(`input`,{type:`checkbox`,id:`chk-orbits`,className:`schematic-checkbox`})]}),(0,$.jsxs)(`label`,{className:`schematic-option`,children:[(0,$.jsx)(`span`,{children:`COORDINATE GRID`}),(0,$.jsx)(`input`,{type:`checkbox`,id:`chk-grid`,className:`schematic-checkbox`})]}),(0,$.jsxs)(`label`,{className:`schematic-option`,children:[(0,$.jsx)(`span`,{children:`CELESTIAL LABELS`}),(0,$.jsx)(`input`,{type:`checkbox`,id:`chk-labels`,className:`schematic-checkbox`})]}),(0,$.jsxs)(`label`,{className:`schematic-option`,children:[(0,$.jsx)(`span`,{children:`SCALE REALISM`}),(0,$.jsx)(`input`,{type:`checkbox`,id:`chk-real-scale`,className:`schematic-checkbox`})]})]})]})]})}function ql(){return(0,$.jsxs)(`div`,{className:`index-panel`,children:[(0,$.jsx)(`span`,{className:`index-title-text`,children:`CELESTIAL INDEX`}),(0,$.jsx)(`div`,{id:`planet-list`,className:`planets-list`})]})}function Jl(){return(0,$.jsxs)(`div`,{id:`target-panel`,className:`target-panel`,children:[(0,$.jsxs)(`div`,{className:`target-title`,children:[(0,$.jsx)(`span`,{className:`target-title-text`,children:`TARGET TELEMETRY`}),(0,$.jsx)(`span`,{id:`target-index`,className:`target-id-text`,children:`ID: 10`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`h2`,{id:`target-name`,className:`target-name-text`,children:`SUN`}),(0,$.jsx)(`p`,{id:`target-class`,className:`target-class`,children:`G2V YELLOW DWARF STAR`})]}),(0,$.jsxs)(`div`,{className:`telemetry-grid`,children:[(0,$.jsxs)(`div`,{className:`telemetry-box`,children:[(0,$.jsx)(`span`,{className:`telemetry-label`,children:`DISTANCE TO SUN`}),(0,$.jsx)(`span`,{id:`telemetry-dist`,className:`telemetry-value`,children:`0.0000 AU`})]}),(0,$.jsxs)(`div`,{className:`telemetry-box`,children:[(0,$.jsx)(`span`,{className:`telemetry-label`,children:`ORBITAL VELOCITY`}),(0,$.jsx)(`span`,{id:`telemetry-vel`,className:`telemetry-value`,children:`0.00 km/s`})]}),(0,$.jsxs)(`div`,{className:`telemetry-box`,children:[(0,$.jsx)(`span`,{className:`telemetry-label`,children:`MASS INDEX`}),(0,$.jsx)(`span`,{id:`telemetry-mass`,className:`telemetry-value`,children:`1.989e30 kg`})]}),(0,$.jsxs)(`div`,{className:`telemetry-box`,children:[(0,$.jsx)(`span`,{className:`telemetry-label`,children:`MEAN TEMP`}),(0,$.jsx)(`span`,{id:`telemetry-temp`,className:`telemetry-value`,children:`5500 °C`})]})]}),(0,$.jsxs)(`div`,{className:`coordinates-box`,children:[(0,$.jsx)(`span`,{className:`coordinates-label`,children:`CARTESIAN COORDINATES (AU)`}),(0,$.jsxs)(`div`,{className:`coordinates-grid`,children:[(0,$.jsxs)(`div`,{children:[`X: `,(0,$.jsx)(`span`,{id:`coord-x`,className:`coordinate-value`,children:`0.0000`})]}),(0,$.jsxs)(`div`,{children:[`Y: `,(0,$.jsx)(`span`,{id:`coord-y`,className:`coordinate-value`,children:`0.0000`})]}),(0,$.jsxs)(`div`,{children:[`Z: `,(0,$.jsx)(`span`,{id:`coord-z`,className:`coordinate-value`,children:`0.0000`})]})]})]})]})}var Yl=`/solar-system-hud/assets/14374912-CQI9Sr8J.png`;function Xl(){return(0,$.jsxs)(`div`,{className:`alpha-panel`,children:[(0,$.jsxs)(`div`,{className:`orbital-feed-header`,children:[(0,$.jsx)(`span`,{className:`alpha-cyan-text`,children:`FEED ALPHA: DIAGNOSTIC INTEL`}),(0,$.jsx)(`span`,{className:`alpha-cyan-text2`,children:`LIVE`})]}),(0,$.jsxs)(`div`,{className:`orbital-feed-content`,children:[(0,$.jsx)(`img`,{src:Yl,className:`orbital-feed-image`,alt:`Wired Reference Uploaded`}),(0,$.jsx)(`div`,{className:`orbital-feed-grid`}),(0,$.jsx)(`div`,{className:`orbital-feed-location`,children:`SYS.LOC: ORB.BETA`})]})]})}var Zl=`/solar-system-hud/assets/Screenshot%202026-06-29%20151907-DoXbFVLp.png`;function Ql(){return(0,$.jsxs)(`div`,{className:`beta-panel`,children:[(0,$.jsxs)(`div`,{className:`subpanel`,children:[(0,$.jsx)(`span`,{className:`beta-orange-text`,children:`FEED BETA: DIAGNOSTIC INTEL`}),(0,$.jsx)(`span`,{className:`beta-orange-text2`,children:`MONITOR`})]}),(0,$.jsxs)(`div`,{className:`subpanel2`,children:[(0,$.jsx)(`img`,{src:Zl,className:`image`,alt:`Thermal Diagnostic Feed`}),(0,$.jsx)(`div`,{className:`subpanel3`}),(0,$.jsx)(`div`,{className:`overlay-text`,children:`SYS.STAT: WARN_LVL_1`})]})]})}function $l(){return(0,$.jsxs)(`div`,{className:`container`,children:[(0,$.jsxs)(`div`,{className:`first-half`,children:[(0,$.jsxs)(`span`,{className:`text-settings`,children:[`STATUS: `,(0,$.jsx)(`span`,{className:`green-text`,children:` ONLINE`})]}),(0,$.jsx)(`span`,{className:`text-settings`,children:`|`}),(0,$.jsxs)(`span`,{className:`text-settings`,children:[`TELEMETRY SOURCE: `,(0,$.jsx)(`span`,{className:`orange-text`,children:` LOCAL ANALYTICAL MODEL`})]})]}),(0,$.jsxs)(`div`,{className:`first-half`,children:[(0,$.jsxs)(`span`,{className:`text-settings`,children:[`LATENCY: `,(0,$.jsx)(`span`,{className:`blue-text`,children:` 589 ms`})]}),(0,$.jsx)(`span`,{className:`text-settings`,children:`|`}),(0,$.jsx)(`span`,{className:`text-settings`,children:`COORDS: J2000 ECLIPTIC`})]})]})}function eu(){let[e,t]=(0,l.useState)(null);return(0,l.useEffect)(()=>{fetch(`http://localhost:3001/api/earth`).then(e=>e.json()).then(e=>{console.log(`Earth:`,e),t(e)}).catch(console.error)},[]),(0,$.jsxs)(`div`,{style:{display:`flex`,flex:`1`,flexDirection:`column`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,flex:`1`,flexDirection:`row`,padding:`1vw`,minHeight:`0`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,flex:`0.5`,flexDirection:`column`,minHeight:`0`},children:[(0,$.jsx)(Gl,{}),(0,$.jsx)(Kl,{}),(0,$.jsx)(ql,{})]}),(0,$.jsx)(Wl,{data:e}),(0,$.jsxs)(`div`,{style:{display:`flex`,flex:`0.5`,flexDirection:`column`,minHeight:`0`},children:[(0,$.jsx)(Jl,{}),(0,$.jsx)(Xl,{}),(0,$.jsx)(Ql,{})]})]}),(0,$.jsx)($l,{})]})}(0,c.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(eu,{}));